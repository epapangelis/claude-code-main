...
* **Android Release 3.0.0 (22/06/2026):**
  * **Νέα Χαρακτηριστικά & Redesigns:** Λειτουργικότητα Login (APPS-611), ανασχεδιασμός Λογαριασμού (APPS-578) και ροής προσθήκης προσωπικών εγγράφων (APPS-604), δυνατότητα δημιουργίας ιδιωτικού οχήματος (APPS-579), και προσθήκη επιλογής "Προσθήκη Οδηγού" για οχήματα σε κατάσταση "Προς Επιστροφή/Λήξη" (APPS-632).
  * **Βελτιώσεις:** Βελτιστοποίηση κλήσεων δικτύου στην Αρχική Οθόνη (APPS-608) και βελτίωση των animations στα Verticals (APPS-612).
  * **Τεχνικές Εργασίες & Refactoring:** Refactoring στα Έγγραφα Οδηγού (APPS-616), αναδιάρθρωση project με νέα animations (APPS-621), και δημιουργία UI Components σε Jetpack Compose (APPS-594).
  * **Bug Fixes:** Επίλυση crash στους πίνακες του Leasing (APPS-605).
* **iOS Release 3.6.0 (22/06/2026):**
  * **Νέα Χαρακτηριστικά & Redesigns:** Ανασχεδιασμός Λογαριασμού (APPS-642) και ανασχεδιασμός οθόνης Προφίλ (APPS-641).
  * **Βελτιώσεις & Τεχνικές Εργασίες:** Διορθώσεις UI (APPS-645), προσθήκη παραμέτρου κρυπτογράφησης (APPS-647), και ενσωμάτωση GitHub Actions (APPS-219).
* **iOS Release 3.6.1 (24/06/2026):**
  * **Bug Fixes:** Επίλυση crash κατά την πλοήγηση από τη σελίδα λεπτομερειών οχήματος (APPS-650) και προσθήκη κουμπιού κλεισίματος στο asking price sheet (APPS-648).
* **Android Release (17/08/2026):**
  * **Redesigns:** Ανασχεδιασμός header οθόνης Προφίλ (APPS-689), ανασχεδιασμός οθόνης Εγγράφων Οχήματος για leasing (APPS-675), και ανανεωμένη Toolbar (APPS-702).
  * **Νέα Χαρακτηριστικά:** Φίλτρο Πωλήσεων (Sales Filter) στη λίστα οχημάτων (APPS-674).
  * **Βελτιώσεις:** Επιδιόρθωση ανοιχτών UI/UX bugs στην οθόνη Login (APPS-655).
  * **Bug Fixes:** Επίλυση crash στην πλοήγηση προς κάμερα στη φόρμα Service (APPS-613), διόρθωση NullPointerException στα Ραντεβού (APPS-681), και επίλυση σφάλματος τιμής σε κενή τιμή στο instatrade (APPS-699).
* **iOS Release (17/08/2026):**
  * **Redesigns:** Ανασχεδιασμός header οθόνης Προφίλ (APPS-686).
  * **Νέα Χαρακτηριστικά:** Φίλτρο Πωλήσεων (Sales Filter) στη λίστα οχημάτων (APPS-673).
